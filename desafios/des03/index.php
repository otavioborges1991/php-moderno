...
<body>
    ...
    <main class="flex-center-items flex-center content">
        <fieldset>
            ...
            <form action="index.php" method="post">
                ...
                <select name="moeda" id="moeda">
                    <option value="dolar" <?= $moeda === 'dolar' ? 'selected' : '' ?>>Dólar para Real</option>
                    <option value="real" <?= $moeda === 'real' ? 'selected' : '' ?>>Real para Dólar</option>
                </select>
        ...
        <div class="border-radius">
            ...
            $moeda_convertida = $moeda === 'dolar' ? 'Reais' : 'Dólares';

            echo "<h2>Resultado da conversão:</h2>";
            echo "<p class='text-align-center'>\$$valorConvertido $moeda_convertida </p>";
            ?>
        </div>
